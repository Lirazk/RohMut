...
cpp_likelihood_hier <- function(mu_f, mu_m, d, len, indexes, male_map, female_map, male_start, female_start, male_end, female_end, prob) {
    .Call(`_RohMut_cpp_likelihood_hier`, mu_f, mu_m, d, len, indexes, male_map, female_map, male_start, female_start, male_end, female_end, prob)
}
