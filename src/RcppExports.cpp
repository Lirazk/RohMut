...
// cpp_em2
NumericVector cpp_em2(double mu1, double mu2, const IntegerVector& mutation, const IntegerVector& len, List& indexes, int maxiter, double eps, const NumericMatrix& prob, bool estimate_intercept, double intercept);
RcppExport SEXP _RohMut_cpp_em2(SEXP mu1SEXP, SEXP mu2SEXP, SEXP mutationSEXP, SEXP lenSEXP, SEXP indexesSEXP, SEXP maxiterSEXP, SEXP epsSEXP, SEXP probSEXP, SEXP estimate_interceptSEXP, SEXP interceptSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< double >::type intercept(interceptSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_em2(mu1, mu2, mutation, len, indexes, maxiter, eps, prob, estimate_intercept, intercept));
    return rcpp_result_gen;
END_RCPP
}
// cpp_em
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_RohMut_cpp_em2", (DL_FUNC) &_RohMut_cpp_em2, 10},
